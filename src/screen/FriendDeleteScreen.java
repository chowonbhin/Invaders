...
public class FriendDeleteScreen implements ActionListener{
    ...
    public FriendDeleteScreen(Connection conn, FriendManager friendManager, String my_id)  {
        ...
        addButton = new JButton("Friend Delete");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == addButton){
            ...
            friendManager.deleteFriend(my_id, friend_id);
        }
